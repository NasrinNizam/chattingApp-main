    ...
    <nav className="bg-[#074173] h-screen w-[200px] px-5 flex flex-col justify-between absolute top-0 left-0  ">
      ...
      <div className="main">
        <ul className="flex-col flex gap-4">
          ...
          <li><NavLink to="/blockPage" className={({ isActive }) => isActive ? " text-[18px] text-white font-medium bg-slate-400 px-3 py-1 rounded-lg flex items-center gap-2 " : " text-[18px] text-white font-normal flex items-center gap-2 "}><IoMdPersonAdd  />Blocked</NavLink></li>
